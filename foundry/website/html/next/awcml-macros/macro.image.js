...
function __define_macro() {
  return /* async */ function() {
    ...
    let url = arguments[1] ??= "?? Placeholder"; // TODO: Placeholder maybe. Maybe macro assets live in this dir.
    let width = arguments[2] ??= "640";
    // TODO: Regex url ~= /^??\s*(.*)$/ and make into placeholder caption.
    return `<center><img src="/.staging/shared/assets/${url}" style="width:${width}px;"/></center>`;
  }
}
