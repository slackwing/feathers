<?php
  ...
  // This makes it so relative paths are relative to the root AWCML directory, i.e. the directory
  // from which awcml.php was executed (e.g. required). This is necessary for example for AWCML
  // pages that live in subdirectories of the root AWCML directory.
  define("AWCML_HEAD_CONTENT", '
