...
(async function () {
  ...
  if (subtitle) {
    ...
    subtitle.innerHTML = `San Diego → New York City<br>${startStr} – ${endStr}, ${yr}<span class="prep-link-wrap"> · <a href="prep.html" class="prep-link" style="color:var(--accent)">checklists!</a> · <a href="notes.html" class="prep-link" style="color:var(--accent)">notes</a></span>`;
  }
})();
