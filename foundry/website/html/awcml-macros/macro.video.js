...
function __define_macro() {
  return /* async */ function() {
    ...
    let width = arguments[2] ??= "65%";
    let cachebuster = new Date();
    // TODO: Parse file extension for type.
    return `
      <div class="awcml-macro-overflow-centered">
        <video style="max-width: ${width};" autoplay loop muted>
          <source src="/.staging/shared/assets/${url}?cachebuster=${cachebuster}" type="video/webm">
        </video>
      </div>
    `;
  }
