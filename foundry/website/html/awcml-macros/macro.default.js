...
function __define_macro() {
  return /* async */ function() {
    ...
    let arg1 = arguments[1] ??= "defaultArgument1";
    let arg2 = arguments[2] ??= "defaultArgument2";
    let arg3 = arguments[3] ??= "defaultArgument3";
    return `<!-- Default (example) macro called with arguments [${arg1}, ${arg2}, ${arg3}]. -->`;
  }
}
